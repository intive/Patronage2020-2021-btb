...
namespace BTB.Persistence.Migrations
{
    ...
    [Migration("20200515123724_AlertMessageTemplates")]
    partial class AlertMessageTemplates
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BTB.Domain.Entities.AlertMessageTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("AlertMessageTemplates");
                });
            ...
            modelBuilder.Entity("BTB.Domain.Entities.Bet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BTB.Domain.Entities.EmailCount", b =>
                {
            ...
            modelBuilder.Entity("BTB.Domain.Entities.GamblePoint", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<decimal>("FreePoints")
                        .HasColumnType("decimal(18, 9)");

                    b.Property<decimal>("SealedPoints")
                        .HasColumnType("decimal(18, 9)");

                    b.HasKey("UserId");

                    b.ToTable("GamblePoints");
                });
            ...
            modelBuilder.Entity("BTB.Domain.Entities.Alert", b =>
                {
                    b.HasOne("BTB.Domain.Entities.AlertMessageTemplate", "MessageTemplate")
                        .WithMany("Alerts")
            ...
            modelBuilder.Entity("BTB.Domain.Entities.GamblePoint", b =>
                {
                    b.HasOne("BTB.Domain.Entities.ApplicationUser", "User")
                        .WithOne("GamblePoints")
                        .HasForeignKey("BTB.Domain.Entities.GamblePoint", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
