...
namespace BTB.Server.Controllers
{
    public class DetailsController : BaseController
    {
        ...
        {
            var priceHistory = await Mediator.Send(new GetPriceHistoryQuery { PairName = symbol, KlineType = interval, PaginationQuantity = pagination.Quantity, AdditionalRows = additional, DataSource = dataSource}, cancellationToken);
